...
if ( ! class_exists( 'MOQC_Add_MOQ_Fields' ) ) {

	/**
	 * Class MOQC_Add_MOQ_Fields.
	 */
	class MOQC_Add_MOQ_Fields {
		...
		/**
		 * all getting products from woocommerce
		 *
		 */
